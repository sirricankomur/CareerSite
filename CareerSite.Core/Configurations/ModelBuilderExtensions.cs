    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder builder)
        {
            builder.Entity<Course>().HasData(
                ...
                new Course() { CourseId = 2, NameTr = "Etkili İletişim", Url = "etkili-iletisim", DescriptionTr = "Kendinizi iyi ifade etmenin yolları.", NameEn = "Effective communication", DescriptionEn = "", Price = 50, ImageUrl = "etkili-iletisim.jpg", IsHome = true, IsApproved = false },
                ...
                new Course() { CourseId = 12, NameTr = "Stresle Başa Çıkma", Url = "stresle-basa-cikma", DescriptionTr = "Stresinizle baş etmenin yolları", NameEn = "Coping with Stress", DescriptionEn = "", Price = 50, ImageUrl = "stresle-basa-cikma.jpg", IsHome = true, IsApproved = true },
